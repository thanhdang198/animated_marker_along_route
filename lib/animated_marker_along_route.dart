library animated_marker_along_route;
...
class SimulateRoute {
  ...
  SimulateRoute(List<LatLng> listLatLng) {
...
class RouteSimulator {
  ...
  RouteSimulator(List<LatLng> listLatLng, TickerProvider vsync,
    ...
    _polyline = SimulateRoute(listLatLng);
    _currentDistance = 0;
    _speed = speed;
  ...
  void addListener(void Function(LatLng?, int?, double?, LatLng?)? listener) {
